...
OrdContainer::OrdContainer(Point init_pos, float scale_factor,
	BatchElement& batch_elem, Character& player, ParticlePool& ruin_pool)
	: ObsContainer(batch_elem, player, ruin_pool)
{
	//initPosX = init_pos.x;
	//initPosX = init_pos.y;
	initPos = init_pos;
